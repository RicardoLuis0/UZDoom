...
const FDefaultShader defaultshaders[] =
{
	...
	{"Warp 1",	"shaders/glsl/func_warp1.fp", "shaders/glsl/material_normal.fp", "#define SHADERTYPE_WARP1\n#define USE_TEXCOORD\n"},
	{"Warp 2",	"shaders/glsl/func_warp2.fp", "shaders/glsl/material_normal.fp", "#define SHADERTYPE_WARP2\n#define USE_TEXCOORD\n"},
...
namespace ShaderInputsOutputs
{
	...
	FString GenerateInputsOutputs(bool isVulkan, bool isFrag, AllShaderIndex type, bool isGBuffer, bool hasClipDistance, const TArray<VaryingFieldDesc> *varyings)
	{
